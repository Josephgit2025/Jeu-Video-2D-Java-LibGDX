...
/**
 * Represents a Sniper unit in the game, a specialized subclass of {@link Soldier}.
 * <p>
 * The Sniper features high attack damage, long range, and fast attack speed, but reduced health.
...
public class Sniper extends Soldier {
    ...
    public Sniper(int posX, int posY, Base allyBase) {
        ...
        /**
         * Sets the health, attack damage, attack speed, movement speed, and range for the Sniper unit.
         * These values are calculated based on base stats and reflect the Sniper's unique gameplay role.
         */
        ...
        /**
         * Loads the walk animation frames for the Sniper unit and sets the animation to loop.
         */
        ...
        /**
         * Loads the attack animation frames for the Sniper unit and sets the animation to play normally.
         */
        ...
        /**
         * Loads the idle animation frames for the Sniper unit and sets the animation to loop.
         */
