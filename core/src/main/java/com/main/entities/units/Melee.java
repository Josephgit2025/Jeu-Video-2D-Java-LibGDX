...
/**
 * Represents a Melee unit in the game, a subclass of {@link Soldier} specialized for close combat.
 * <p>
 * The Melee unit features increased health, reduced attack damage, and short range.
 * It uses custom animation frames for walking, attacking, and idle states, and interacts with bases and other entities.
 */
public class Melee extends Soldier {
     ...
     * Initializes stats, range, and loads all relevant animations for walking, attacking, and idle states.
     *
    ...
    public Melee(float posX, float posY, Base allyBase) {
        ...
        /**
         * Sets the health, attack damage, attack speed, movement speed, and range for the Melee unit.
         * These values are calculated based on base stats and reflect the Melee's unique gameplay role.
         */
        ...
        /**
         * Loads the walk animation frames for the Melee unit and sets the animation to loop.
         */
        ...
        /**
         * Loads the attack animation frames for the Melee unit and sets the animation to play normally.
         */
        ...
        /**
         * Loads the idle frame for the Melee unit from the first walk frame.
         * Used when the unit is not moving or attacking.
         */
